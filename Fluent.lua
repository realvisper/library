...
local aa = {
	...
	[47] = function()
		...
		local af = {Names = {"Dark", "Darker", "Light", "Aqua", "Amethyst", "Rose", "Quizzy"}}
	...
	[50] = function()
		...
		return {
			...
			ElementBorder = Color3.fromRGB(26, 24, 24),
			...
			DropdownHolder = Color3.fromRGB(11, 9, 11),
			...
			Dialog = Color3.fromRGB(11, 9, 11),
			DialogHolder = Color3.fromRGB(35, 35, 35),
			DialogHolderLine = Color3.fromRGB(30, 30, 30),
			DialogButton = Color3.fromRGB(11, 9, 11),
	...
	[51] = function()
		...
		return {
			...
			Dialog = Color3.fromRGB(34, 28, 34),
			DialogHolder = Color3.fromRGB(25, 25, 25),
			DialogHolderLine = Color3.fromRGB(20, 20, 20),
			DialogButton = Color3.fromRGB(35, 35, 35),
			DialogButtonBorder = Color3.fromRGB(55, 55, 55),
			DialogBorder = Color3.fromRGB(50, 50, 50),
			DialogInput = Color3.fromRGB(11, 9, 11),
	...
	[54] = function()
		...
		return {
			...
			AcrylicBorder = Color3.fromRGB(42, 42, 42),
			...
			ElementBorder = Color3.fromRGB(17, 15, 15),
			InElementBorder = Color3.fromRGB(90, 90, 90),
			ElementTransparency = 0.87,
			ToggleSlider = Color3.fromRGB(120, 120, 120),
			...
			DropdownFrame = Color3.fromRGB(160, 160, 160),
			DropdownHolder = Color3.fromRGB(11, 9, 11),
			DropdownBorder = Color3.fromRGB(17, 15, 15),
			DropdownOption = Color3.fromRGB(120, 120, 120),
			Keybind = Color3.fromRGB(120, 120, 120),
			Input = Color3.fromRGB(160, 160, 160),
			InputFocused = Color3.fromRGB(10, 10, 10),
			InputIndicator = Color3.fromRGB(150, 150, 150),
			Dialog = Color3.fromRGB(23, 20, 20),
			DialogHolder = Color3.fromRGB(17, 15, 15),
			DialogHolderLine = Color3.fromRGB(30, 30, 30),
			DialogButton = Color3.fromRGB(32, 33, 34),
			DialogButtonBorder = Color3.fromRGB(80, 80, 80),
			DialogBorder = Color3.fromRGB(42, 42, 42),
			DialogInput = Color3.fromRGB(55, 55, 55),
			DialogInputLine = Color3.fromRGB(160, 160, 160),
			Text = Color3.fromRGB(240, 240, 240),
			SubText = Color3.fromRGB(170, 170, 170),
